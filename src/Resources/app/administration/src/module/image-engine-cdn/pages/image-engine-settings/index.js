        ...
        config: {
            handler() {
                ...
                if (salesChannelId === null) {
                    this.cdnDomainFilled = !!this.config['ImageEngineCdn.config.cdnDomain'];
                    this.shopDomainFilled = !!this.config['ImageEngineCdn.config.shopDomain'];
                } else {
                    this.cdnDomainFilled = !!this.config['ImageEngineCdn.config.cdnDomain']
                        || !!defaultConfig['ImageEngineCdn.config.cdnDomain'];
                    this.shopDomainFilled = !!this.config['ImageEngineCdn.config.shopDomain']
                        || !!defaultConfig['ImageEngineCdn.config.shopDomain'];
                }
            },
            deep: true,
        },
